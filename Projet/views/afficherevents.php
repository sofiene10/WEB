      ...
      <div class="container-fluid page-body-wrapper">
		...
		<div class="card">
              ...
              <th>destination Evenement</th>
                      ...
                      <tbody>
					  <tr>
						<td><?PHP echo $event['IDEvenement']; ?></td>
						<td><?PHP echo $event['destinationEvenement']; ?></td>
						<td><?PHP echo $event['dateEvenement']; ?></td>
						<td><?PHP echo $event['prixEvenement']; ?></td>
						<td><?PHP echo $event['NomEvenement']; ?></td>
					<td>
						<form method="POST" action="supprimerevents.php">
						<input type="submit" class="btn btn-danger btn-fw" name="supprimer" value="supprimer">
						<input type="hidden" value=<?PHP echo $event['IDEvenement']; ?> name="IDEvenement">
						</form>
					</td>
					<td>
					<a class="btn btn-primary btn-fw" href="modifierevents.php?IDEvenement=<?PHP echo $event['IDEvenement']; ?>"> Modifier </a>
					</td>
				</tr>
			<?PHP
				}
