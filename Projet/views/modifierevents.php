  ...
  session_start();
	...
	if (
		...
		if (
            ...
            $eventC->modifierevent($evt, $_GET['IDEvenement']);
  ...
  <div id="error">
        ...
        <?php
			if (isset($_GET['IDEvenement'])){
				$evt = $eventC->recupererevent($_GET['IDEvenement']);
                  ...
                  <div class="card-body">
                    ...
                    <form action="" method="POST" class="form-sample">
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">ID evenement</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" name="IDEvenement" id="IDEvenement"  value = "<?php echo $evt['IDEvenement']; ?>" disabled>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Nom evenement</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" name="NomEvenement" id="NomEvenement" maxlength="20" value = "<?php echo $evt['NomEvenement']; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Destination evenement</label>
                            <div class="col-sm-9">
                            <input type="text" class="form-control" name="destinationEvenement" id="destinationEvenement" maxlength="20" value = "<?php echo $evt['destinationEvenement']; ?>">
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Prix evenement</label>
                            <div class="col-sm-9">
                            <input type="number" class="form-control" name="prixEvenement" id="prixEvenement" maxlength="20" value = "<?php echo $evt['prixEvenement']; ?>">
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                            <input type="date" class="form-control" name="dateEvenement" id="dateEvenement" value = "<?php echo $evt['dateEvenement']; ?>">    
                            </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="form-group row">
                            <label class="col-sm-3 col-form-label">Image evenement</label>
                            <div class="col-sm-9">
