        ...
        <div class="row">
          <div class="col-md-12">
            <div class="text-content">
              ...
              <h2>voici nos evenements disponible</h2>
            </div>
          </div>
        </div>
      </div>
            ...
            <div class="product-item">
              ...
              <div class="down-content">
                ...
                <small>
                     ...
                     <form method="POST" action="participerevent.php">
                    <input type="submit" class="btn btn-warning btn-fw" name="participer" value="participer">
                    <input type="hidden" value=<?PHP echo $event['IDEvenement']; ?> name="EvenementFK">
